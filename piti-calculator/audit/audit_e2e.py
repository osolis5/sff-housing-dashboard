...
Scrape of 2026-08-18 taken from the three-panel dashboard-layout build
(Housing rail | results canvas | People rail; editable People-rail benchmark
incomes left at their dataset defaults). Values match the 2026-08-12 scrape:
tiers, 1.5%-of-price live tax default, custom-tax states, and the profile gap
column (max affordable price − scenario price) are all unchanged."""
import json, math
